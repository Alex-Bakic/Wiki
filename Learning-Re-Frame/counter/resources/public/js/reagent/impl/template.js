...
var G__22499 = o;
(G__22499[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__22503 = o;
(G__22503[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__22504__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
return G__22504__delegate.call(this,args);};
...
return G__22504__delegate(args);
});
...
var G__22508 = props;
var G__22508__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__22508,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22508);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__22508__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__22509){
...
var props = map__22510__$1;
var class$ = cljs.core.get.call(null,map__22510__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__22510,map__22510__$1,props,class$){
return (function (c){
...
});})(map__22510,map__22510__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__22512){
...
var on_write = cljs.core.get.call(null,map__22513__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__22513,map__22513__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__22513,map__22513__$1,on_write))
);
} else {
...
var G__22516 = jsprops;
(G__22516["defaultValue"] = value);

(G__22516["onChange"] = ((function (G__22516,v,value,on_change){
return (function (p1__22515_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__22515_SHARP_);
});})(G__22516,v,value,on_change))
);
...
var vec__22519 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__22519,(0),null);
var id = cljs.core.nth.call(null,vec__22519,(1),null);
var class$ = cljs.core.nth.call(null,vec__22519,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___22523 = reagent.impl.template.key_from_vec.call(null,v);
...
var temp__5461__auto___22525 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___22525 == null)){
} else {
var key_22526 = temp__5461__auto___22525;
reagent.impl.template.oset.call(null,jsprops,"key",key_22526);
}
...
var G__22527 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__22527["name"] = c);
...
var len__4641__auto___22532 = arguments.length;
var i__4642__auto___22533 = (0);
while(true){
if((i__4642__auto___22533 < len__4641__auto___22532)){
args__4647__auto__.push((arguments[i__4642__auto___22533]));

var G__22534 = (i__4642__auto___22533 + (1));
i__4642__auto___22533 = G__22534;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22530){
var G__22531 = cljs.core.first.call(null,seq22530);
var seq22530__$1 = cljs.core.next.call(null,seq22530);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22531,seq22530__$1);
});
...
break;
default:
var G__22537 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__22537;
continue;
...
var n__4518__auto___22539 = a.length;
var i_22540 = (0);
while(true){
if((i_22540 < n__4518__auto___22539)){
(a[i_22540] = reagent.impl.template.as_element.call(null,(a[i_22540])));

var G__22541 = (i_22540 + (1));
i_22540 = G__22541;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4518__auto___22542 = a.length;
var i_22543 = (0);
while(true){
if((i_22543 < n__4518__auto___22542)){
var val_22544 = (a[i_22543]);
if(((cljs.core.vector_QMARK_.call(null,val_22544)) && ((reagent.impl.template.key_from_vec.call(null,val_22544) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22543] = reagent.impl.template.as_element.call(null,val_22544));

var G__22545 = (i_22543 + (1));
i_22543 = G__22545;
continue;
} else {
}
...
var ctx = ({});
var vec__22546 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__22546,(0),null);
var derefed = cljs.core.nth.call(null,vec__22546,(1),null);
...
var G__22549 = (cljs.core.count.call(null,argv) - first_child);
switch (G__22549) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__22549){
...
//# sourceMappingURL=template.js.map?rel=1544375469236
