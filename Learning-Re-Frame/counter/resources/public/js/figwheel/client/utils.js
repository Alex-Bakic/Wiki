...
return (new CustomEvent(event_name,(function (){var obj28370 = {"detail":data};
return obj28370;
})()));
} else {
...
var f = (function (){var pred__28377 = cljs.core._EQ_;
var expr__28378 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28377.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28378))){
return ((function (pred__28377,expr__28378){
return (function (p1__28371_SHARP_){
return console.warn(p1__28371_SHARP_);
});
;})(pred__28377,expr__28378))
} else {
if(cljs.core.truth_(pred__28377.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28378))){
return ((function (pred__28377,expr__28378){
return (function (p1__28372_SHARP_){
return console.debug(p1__28372_SHARP_);
});
;})(pred__28377,expr__28378))
} else {
if(cljs.core.truth_(pred__28377.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28378))){
return ((function (pred__28377,expr__28378){
return (function (p1__28373_SHARP_){
return console.error(p1__28373_SHARP_);
});
;})(pred__28377,expr__28378))
} else {
return ((function (pred__28377,expr__28378){
return (function (p1__28374_SHARP_){
return console.log(p1__28374_SHARP_);
});
;})(pred__28377,expr__28378))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28381){
...
var eval_fn = cljs.core.get.call(null,map__28382__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28384_SHARP_);
});})(new_def))
);
...
return (function (p__28385){
var vec__28386 = p__28385;
var ky = cljs.core.nth.call(null,vec__28386,(0),null);
var v = cljs.core.nth.call(null,vec__28386,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1544375480107
